                        ...
                        ?>
                            ...
                            <div class="col-sm-3">
                                @if(!empty($cat_logo) && $cat_logo != '')
                                    @if($cat_logo != '' && Storage::size(Config::get('constant.CATEGORY_LOGO_THUMBNAIL_IMAGE_PATH').$cat_logo) > 0)
                                        <img src="{{ Storage::url(Config::get('constant.CATEGORY_LOGO_THUMBNAIL_IMAGE_PATH').$cat_logo) }}" width="50" height="50" class="report-image img-thumbnail"/>
                                    @else
                        ...
                        ?>
                            ...
                            <div class="col-sm-3">
                                @if(!empty($banner_img) && $banner_img != '')
                                    ...
                                    @if($banner_img != '' && Storage::size(Config::get('constant.CATEGORY_BANNER_ORIGINAL_IMAGE_PATH').$banner_img) > 0)
                                        <img src="{{ Storage::url(Config::get('constant.CATEGORY_BANNER_ORIGINAL_IMAGE_PATH').$banner_img) }}" class="report-image img-thumbnail" alt="{{$banner_img}}" height="50" width="100"/>
                                    @else
